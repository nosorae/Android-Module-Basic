package nosorae.module_basic.p21_dust
...
import nosorae.module_basic.databinding.ActivityDustBinding
        ...
        with(measuredValue) {
            ...
            with(binding.dustNo2Item) {
                ...
                viewDustTextGrade.text = (no2Grade
                    ?: nosorae.module_basic.p21_dust.data.models.airquality.AirQualityGrade.UNKNOWN).toString()
